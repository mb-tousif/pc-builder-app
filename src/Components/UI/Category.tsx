  ...
  return (
    <>
        ...
        {categories?.map((category) => {
          return (
            <Link key={category.id} href={category.link}>
              <div className="p-2 text-center bg-gradient-to-r from-[#D0DAE3] to-[#ADCDED] hover:from-[#3A8678] rounded-2xl text-[#523d03]">
                <div className="mx-auto">{category.logo}</div>
      ...
      <div className="flex justify-center">
        <Link href="/others ">
          <div className="p-2 w-[310px] sm:w-[400px] mb-4 text-center bg-gradient-to-r from-[#D0DAE3] to-[#ADCDED] hover:from-[#3A8678] rounded-2xl text-[#523d03]">
